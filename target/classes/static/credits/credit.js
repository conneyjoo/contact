...
var creditGrid = $('#creditGrid').grid({
    method: 'GET',
    url: '/credit/findCredits',
    ...
    afterLoad: function(data) {
        ...
        $('.forword').click(function() {
            var el = $(this);
            creditGrid.rows[el.data('index') - 1].click();
            var curPage = creditGrid.params.curPage;
            var pageSize = creditGrid.params.pageSize;
            var selectedIndex = creditGrid.getSelected() ? creditGrid.getSelected().rowIndex - 1 : '';
...
creditGrid.on('rowdoubleclick', function(event) {
    showEditPanel();
});
...
showEditPanel = function() {
    ...
    var row = creditGrid.getSelected();
