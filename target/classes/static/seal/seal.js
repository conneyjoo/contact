...
var sealGrid = $('#sealGrid').grid({
    ...
    afterLoad: function(data) {
        ...
        $('.forword').click(function() {
            var el = $(this);
            sealGrid.rows[el.data('index') - 1].click();
            var curPage = sealGrid.params.curPage;
            var pageSize = sealGrid.params.pageSize;
            var selectedIndex = sealGrid.getSelected() ? sealGrid.getSelected().rowIndex - 1 : '';
...
sealGrid.on('rowdoubleclick', function(event) {
    showEditPanel();
});
