...
(function($, window, Plupload, Moxie, undefined) {
    ...
    var Uploader = function(element, options) {
        ...
        if(dropPlaceholder) $dropElement.attr('data-drop-placeholder.js', dropPlaceholder);
    ...
    Uploader.prototype.mergeData = function(data) {
    	if (data.originalFilenames) data.originalFilenames = null;
    	if (data.tempFiles) data.tempFiles = null;
    	...
    	data.originalFilenames = originalFilenames.join();
